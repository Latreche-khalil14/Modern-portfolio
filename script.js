...
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
      "Computer Science student & Web Developer passionate about",
      "#ffffff"
    )}
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
...
${this.wrapWithColor("⚡ Focus Areas", "#ff8c00")}
${this.wrapWithColor(
  "   Building clean and modern web applications using",
  "#ffffff"
)}
${this.wrapWithColor("   HTML, CSS, JavaScript, PHP, Java, and SQL", "#ff8c00")}

${this.wrapWithColor("⚡ Passion", "#ff8c00")}
${this.wrapWithColor(
  "   Exploring AI technologies and integrating them to create",
  "#ffffff"
)}
${this.wrapWithColor(
...
${this.wrapWithColor(
  "   Continuously learning software architecture and building",
  "#ffffff"
)}
${this.wrapWithColor("   practical, real-world projects", "#ffffff")}
...
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
      "Ready to collaborate and build amazing software!",
      "#ffffff"
...
${this.wrapWithColor(
  ...
  showExperience(outputElement = this.output) {
    const experience = `<span style="color: #ffff00; font-weight: bold;">💼 Journey & Practice</span>

<span style="color: #00ffff;">UNIVERSITY OF SKIKDA | Computer Science Student</span>
${this.wrapWithColor(
  "2023 - 2026 | Skikda, Algeria",
  "#ffffff"
)}
${this.wrapWithColor(
  "Academic foundation in programming, databases, and algorithms",
  "#98fb98"
)}
...
• ${this.wrapWithColor("NoSQL", "#ffffff")}
...
${this.wrapWithColor("✉", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="mailto:latrechekhalil95@gmail.com" style="color: #ffffff; text-decoration: none;">latrechekhalil95@gmail.com</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("🌐", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://latreche-khalil14.github.io" target="_blank" style="color: #ffffff; text-decoration: none;">latreche-khalil14.github.io</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("⚡", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://github.com/Latreche-khalil14" target="_blank" style="color: #ffffff; text-decoration: none;">github.com/Latreche-khalil14</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("💼", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://www.linkedin.com/in/khalil-latreche-5a9a18382/" target="_blank" style="color: #ffffff; text-decoration: none;">linkedin.com/in/khalil-latreche</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("╰────────────────────────────────────────╯", "#ff8c00")}`;
  ...
  generateLinkedInCover(outputElement) {
    ...
    terminalTitle.textContent = "khalil@latreche: ~/interactive-resume";
...
╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝╚══════╝╚═╝╚══════╝`;
    ...
    role.textContent = "Web Developer • Computer Science Student";
    ...
    url.textContent = "latreche-khalil14.github.io";
